...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('mango candle', 'Alice', '10', TRUE),
('peach wine', 'Nick', '33', TRUE),
('cherry wine', 'Bob', '40', FALSE),
('berry essential oil', 'Lyle', '29', FALSE),
('whiskey', 'Big Boss', '150', TRUE)
;
...
-- 
UPDATE gift SET price = 2999 WHERE id = 2
