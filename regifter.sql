...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('vanilla candle', 'Santa', 15, TRUE),
('wild cotton wax melts', 'Jack', 6, FALSE),
('digital gift card', 'Rudolf', 25, FALSE),
('touchscreen Gloves', 'James', '29', TRUE),
('hand massager', 'Brian', '39', FALSE);
