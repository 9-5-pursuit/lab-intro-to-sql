...
-- 
ALTER TABLE gifts ALTER COLUMN value TYPE price;
ALTER TABLE gifts RENAME COLUMN is_active TO previously_regifted;

-- 
\echo Insert a peach candle, given by 'Santa' thats price is 9 and has been previously regifted
-- 
INSERT INTO gifts (gifts ,giver, value, previously_regifted)
...
INSERT INTO gifts (gifts, giver, price, previously_regifted)
VALUES
...
--
INSERT INTO gifts(gifts, giver, price, previously_regifted)
VALUES ('coconut candle', 'Mrs. Clause', '10', FALSE),
('pineappe', 'Spongebob', '15', TRUE),
('crabby Patty', 'Mr. Crabs', '15', FALSE),
('backpack', 'Dora', '25', TRUE),
('gloves', 'smurf', '50', TRUE);
