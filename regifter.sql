...
VALUES
('PS5', 'chan', '39', TRUE),
('hot wheels', 'kiara', '26', TRUE),
('puppy', 'Dad', '39', TRUE),
('skateborad', 'neighbor', '19', FALSE)
('santal 33 candle', 'The best friend', '95', TRUE)
;
...
-- 
UPDATE gift SET price TO 2999 WHERE id = 2
