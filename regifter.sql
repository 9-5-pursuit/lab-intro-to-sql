...
INSERT INTO
  gifts(gift, giver, price, previously_regifted)
VALUES
  ('snowball maker', 'Frosty', 5, FALSE),
  ('snow globe', 'Mrs Claus', 23, TRUE),
  ('champagne candle', 'Secret Santa', 25, FALSE),
  ('chocolate chip cookies', 'Comet', 9, FALSE),
  ('scarf', 'Jack', 12, TRUE);
...
SELECT * FROM gifts 
ORDER BY price DESC LIMIT 3 OFFSET 2;
