...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('chocolate candle', 'Blitzen', '10', FALSE),
('tiramasu candle', 'Ben', '20', TRUE),
('soup on the pope', 'campbells', '30', FALSE),
('whole chicken', 'chicken', '40', TRUE),
('custard candle', 'Big Boss', '50', FALSE);
--
