...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('cinnamon apple candle', 'Mrs. Clause', '12', TRUE),
('cinnamon candy cane', 'Chris', '7', TRUE),
('Elf on the Shelf', 'Buddy', '15', FALSE),
('Reindeer-nip', 'Workshop Elf', '59', TRUE),
('Ice and Hills', 'Rudolph', '19', FALSE)
;
