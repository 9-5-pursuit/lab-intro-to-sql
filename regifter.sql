...
CREATE TABLE gifts(id serial, gift VARCHAR(30), giver VARCHAR(20), price INT, previously_regifted BOOLEAN );
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('hot wheels', 'Santa', '10', TRUE),
('crayons', 'Nicho', '20', TRUE),
('robo dog', 'Russell', '390', FALSE),
('pepper pig', 'David', '32', TRUE),
('burberry', 'The Boss', '490', FALSE);
