...
INSERT INTO gifts(gift, giver, price, previously_regifted)
VALUES
    ('apple candle', 'Yanako', '12', FALSE),
    ('water bottle', 'Elena', '2', FALSE),
    ('pop tart', 'Nelly', '6', FALSE),
    ('nutella', 'Yanako', '10', FALSE),
    ('orange juice', 'Luz', '4', TRUE);
...
--
\echo Query for every gift whose giver is Santa OR priece is greater than 30
--
...
--
SELECT * FROM gifts WHERE NOT giver ILIKE 'Santa';
