...
-- 
ALTER TABLE giftsALTER TABLE gifts RENAME COLUMN value to price;
-- 
...
('mint candle', 'Nicki', '9', TRUE),
('blossom candle', 'Jose', '21', FALSE),
('bracelet', 'Sam', '59', TRUE),
('necklace', 'Jeff', '99', FALSE)
;
...
--
DELETE FROM gifts WHERE giver = 'Santa' RETURNING price;
