...
VALUES
    ...
    ('potpourri', 'Elf on the Shelf', 39, TRUE),
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
    ('lavender candle', 'Amanda', 15, FALSE),
    ('scented lotion', 'John', 25, FALSE),
    ('chocolate box', 'Marisa', 12, FALSE),
    ('gourmet coffee', 'Mike', 8, FALSE),
    ('Final Fantasy 16', 'Mom', 70, FALSE);
