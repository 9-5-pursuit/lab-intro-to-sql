...
INSERT INTO
  gifts (gift, giver, price, previously_gifted)
  VALUES
...
VALUES
('boat', 'Santa', '10000', TRUE),
('car', 'Nick', '3000', TRUE),
('Fan', 'Rudolf', '50', FALSE),
('Bike', 'Elf on the Shelf', '400', TRUE),
('cups', 'The Boss', '2', FALSE)
;
...
SELECT * FROM gifts WHERE gift LIKE 'candle' OR price >= 30;
...
UPDATE gifts SET price = 2999 WHERE id = 7;

--
\echo Query for the updated item
--

SELECT * FROM gifts WHERE id = 7;
