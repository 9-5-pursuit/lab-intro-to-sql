...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('jasmine+patchouli candle','Judy',12, FALSE),
('Shower oil', 'Santa', 22, FALSE),
('knitted sweater', 'Mom', 39, TRUE),
('fuzzy sock', 'Co-worker', 15, TRUE),
('scotch whiskey', 'Greg', 56 FALSE)
;
--
...
-- 
UPDATE gifts SET price = 2499 WHERE id = 2;

--
\echo Query for the updated item
--
UPDATE gifts SET price = 2499 WHERE id = 2 RETURNING *; 
